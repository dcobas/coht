struct cmd_desc user_cmds[] = {
	{ 1, CmdLUN,		"lun", "select device", "lun [lun]", 0,
				cmd_lun },
	{ 1, CmdVERSION,	"version", "get module version", "ver", 0,
				cmd_version },
	{ 1, CmdMODE,		"mode", "get/set mode of operation", "mode [optical_16|"
					"copper_16|btrain_counter|parallel_input|"
					"optical_2_16|copper_2_16|serial_32]", 0,
				cmd_mode },
	{ 1, CmdHSTATUS,	"hstatus", "get hardware status", "hstatus", 0,
				cmd_hstatus },
	{ 1, CmdTIMEOUT,	"timeout", "get/set interrupt timeout", "timeout", 0,
				cmd_timeout },
	{ 1, CmdPOLARITY,	"polarity", "get/set pulse polarity", "polarity [positive|negative]", 0,
				cmd_polarity },
	{ 1, CmdENABLE,		"enable", "enable module", "enable", 0,
				cmd_enable },
	{ 1, CmdDISABLE,	"disable", "disable module", "disable", 0,
				cmd_disable },
	{ 1, CmdENABLE_INT,	"enable_int", "enable interrupts", "enable_int", 0,
				cmd_timeout },
	{ 1, CmdDISABLE_INT,	"disable_int", "disable interrupts", "disable_int", 0,
				cmd_timeout },
	{ 1, CmdWAIT,		"wait", "wait for interrupt", "wait", 0,
				cmd_wait },
	{ 1, CmdSOFT_START	"soft_start", "issue a soft start", "soft_start", 0,
				cmd_soft_start },
	{ 1, CmdSOFT_STOP	"soft_stop", "issue a soft stop", "soft_stop", 0,
				cmd_soft_stop },
	{ 1, CmdSOFT_REARM	"soft_rearm", "issue a soft rearm", "soft_rearm", 0,
				cmd_soft_rearm },
	{ 1, CmdCH_MASK,	"ch_mask", "get/set channels mask", "ch_mask [mask]", 0,
				cmd_timeout },
	{ 0, }
};
