...
/*
 * The doccumentation is just plain wrong, on a little endian platform the
 * MBLT function address bits in reg MBLT_ENDIAN register [0x7fbf3 need to
 * be set to one. After that on little_endian, we need to word swap !!
 */
