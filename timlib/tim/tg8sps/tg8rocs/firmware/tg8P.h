...
static unsigned short curms;     /* Current milli second */
static unsigned short lstms;     /* Last millisecond */
static unsigned short incms;     /* Difference curms - lstms */
static unsigned short curhd;     /* Current header */
static unsigned short sscms;     /* SSC millisecond */
static unsigned short remms;     /* Remaining millisecond */
