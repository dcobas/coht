 ...
 * @file libvmod12a4.h
 *
 * @brief VMOD12a4 driver library interface
 *
 * This file describes the external interface to the VMOD12A4
...
#ifndef _LIBVMOD12A4_H_
#define _LIBVMOD12A4_H_
...
/**
 * @brief Get a handle for a vmod12a4 device
 *
